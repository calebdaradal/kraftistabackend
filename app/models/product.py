...
class Collection(Base):
    ...
    __table_args__ = (UniqueConstraint("slug", name="uq_collections_slug"), UniqueConstraint("name", name="uq_collections_name"))
    ...
    products: Mapped[list["Product"]] = relationship("Product", back_populates="collection_ref")
...
class Product(Base):
    ...
    collection_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("collections.id"), nullable=True, index=True)
    ...
    dimension_width_cm: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), nullable=True)
    dimension_height_cm: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), nullable=True)
    dimension_length_cm: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), nullable=True)
    ...
    collection_ref: Mapped[Collection | None] = relationship("Collection", back_populates="products")
